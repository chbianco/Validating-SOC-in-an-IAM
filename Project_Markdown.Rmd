...
Based on the AIC for each ANOVA, the tests accounting for data source + transition type and data soruce + basin + transition type were used. These tests whoed no significant difference in means based on data source. 
